...
image1 = cv2.imread(image_path + r"\5.jpg")
# Get screen information
screen = screeninfo.get_monitors()[1]  # Assuming a single monitor setup
screen_width, screen_height = screen.width, screen.height

# Calculate the new size of the image
new_width = int(screen_width * 0.20)
# new_height = int(screen_height * 0.20)
...
for path in image_paths:
    ...
    # Display the images and black pixel count
