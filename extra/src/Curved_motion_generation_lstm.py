...
from extra.models.LSTM_6_working_C import BASE
...
# Syntax:
# python -m src.Curved_motion_generation_lstm logs\learning_logs\wiping\20221124_124306-C_Wipe_auto_lstm-drop0.3_c4dfe92
# 20221124_124306-C_Wipe_auto_lstm-drop0.3_c4dfe92(working curved steel bowl)
...
def generate_motion(log_dir, step, input_param, model_path, cam_num):
    try:
        ...
        # goal = dict(xm540=[nangle, nangle, nangle], pro=DymControl.getj(servo))
        ...
        Wipe_C_g = DymControl.Wipe_Generator(
        ...
        for t in range(step):
            ...
            # Move Dym
            if servo == "xm540":
                xm540_align_angles = DymControl.rounderror(yposition, 245.0, servo)

                print("y_position", xm540_align_angles, yposition, ycurrent)
                print(
                    "xm540 ",
                    DymControl.value2angle(xm540_align_angles, "xm540"),
                    "PRO",
                ...
                # xm540_align_angles[2]=2048
                goal[servo] = xm540_align_angles
            if servo == "pro":
                ...
                # print("y_position",yposition,pro_filtered_values)#,xm540_align_angles)
                print(
                    "angle actual",
